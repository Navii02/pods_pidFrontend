...
export const deleteStatus = async (statusId) => {
  try {
    const response = await commonApi(
      "DELETE",
      `${url}/api/comment/delete-comment/${statusId}`
    );
    return response;
  } catch (error) {
    throw error;
...
export const deleteAllComment = async (id) => {
  ...
  try {
    const response = await commonApi(
      "DELETE",
      `${url}/api/delete=all-comments/${id}`
    );
    return response;
  } catch (error) {
    throw error;
...
export const updateCommentField = async (data) => {
  console.log(data);
  try {
    const response = await commonApi("PUT", `${url}/api/update-comment-infield`, data);
    return response;
  } catch (error) {
    throw error;
  }
