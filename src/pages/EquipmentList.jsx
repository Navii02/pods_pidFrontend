...
function EquipmentList() {
  ...
  const handleSelectAllCheckbox = (e) => {
    if (e.target.checked) {
      setSelectedEquipmentIds(filteredEquipmentList.map((equipment) => equipment.tagId));
    } else {
          ...
          <table className='eqptable'>
            <thead>
              <tr>
                ...
                <th>Revision date</th>
                <th>
                  <i className="fa-solid fa-upload" title="Export" onClick={handleExport} style={{ cursor: 'pointer' }}></i>
                  <i className="fa-solid fa-download ms-2" title="Import" onClick={handleImportTag} style={{ cursor: 'pointer' }}></i>
                  <i className="fa-solid fa-trash ms-2" title="Delete Selected" onClick={handleMultipleDelete} style={{ cursor: 'pointer' }}></i>
                </th>
              </tr>
              <tr>
                <th colSpan={22}>
                ...
                <tr key={equipment.tagId || index} style={{ color: 'black' }}>
                  ...
                  <td>
                    <input
                      ...
                      onChange={(e) =>
                        handleEquipmentCheckboxChange(equipment.tagId, e.target.checked)
                      }
                    />
                  </td>
                  <td style={{ backgroundColor: '#f0f0f0' }}>{equipment.tag}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('descr', e.target.value)} type="text" value={editedEquipmentData.descr || ''} /> : equipment.descr}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('qty', e.target.value)} type="text" value={editedEquipmentData.qty || ''} /> : equipment.qty}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('capacity', e.target.value)} type="text" value={editedEquipmentData.capacity || ''} /> : equipment.capacity}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('type', e.target.value)} type="text" value={editedEquipmentData.type || ''} /> : equipment.type}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('materials', e.target.value)} type="text" value={editedEquipmentData.materials || ''} /> : equipment.materials}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('capacityDuty', e.target.value)} type="text" value={editedEquipmentData.capacityDuty || ''} /> : equipment.capacityDuty}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('dims', e.target.value)} type="text" value={editedEquipmentData.dims || ''} /> : equipment.dims}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('dsgnPress', e.target.value)} type="text" value={editedEquipmentData.dsgnPress || ''} /> : equipment.dsgnPress}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('opPress', e.target.value)} type="text" value={editedEquipmentData.opPress || ''} /> : equipment.opPress}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('dsgnTemp', e.target.value)} type="text" value={editedEquipmentData.dsgnTemp || ''} /> : equipment.dsgnTemp}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('opTemp', e.target.value)} type="text" value={editedEquipmentData.opTemp || ''} /> : equipment.opTemp}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('dryWeight', e.target.value)} type="text" value={editedEquipmentData.dryWeight || ''} /> : equipment.dryWeight}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('opWeight', e.target.value)} type="text" value={editedEquipmentData.opWeight || ''} /> : equipment.opWeight}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('supplier', e.target.value)} type="text" value={editedEquipmentData.supplier || ''} /> : equipment.supplier}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('remarks', e.target.value)} type="text" value={editedEquipmentData.remarks || ''} /> : equipment.remarks}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('initStatus', e.target.value)} type="text" value={editedEquipmentData.initStatus || ''} /> : equipment.initStatus}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('revision', e.target.value)} type="text" value={editedEquipmentData.revision || ''} /> : equipment.revision}</td>
                  <td>{editedEquipmentId === equipment.tagId ? <input onChange={e => handleChange('revisionDate', e.target.value)} type="date" value={editedEquipmentData.revisionDate || ''} /> : equipment.revisionDate}</td>
                  <td style={{ backgroundColor: '#f0f0f0' }}>
                    {editedEquipmentId === equipment.tagId ?
                      <>
                        <i className="fa-solid fa-floppy-disk text-success" onClick={() => handleSave(equipment.tag)} style={{ cursor: 'pointer' }}></i>
                        <i className="fa-solid fa-xmark ms-3 text-danger" onClick={handleCloseEdit} style={{ cursor: 'pointer' }}></i>
                      </>
                      :
                      <>
                        <i className="fa-solid fa-pencil" onClick={() => handleEditOpen(equipment)} style={{ cursor: 'pointer' }}></i>
                        <i className="fa-solid fa-trash-can ms-3" onClick={() => handleDeleteEquipmentFromTable(equipment.tagId)} style={{ cursor: 'pointer' }}></i>
                      </>
                    }
                  </td>
                </tr>
