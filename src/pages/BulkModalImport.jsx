...
import "../styles/BulkModelImport.css";
...
function BulkModelImport({ setLoading }) {
  ...
  const [convertedFile, setConvertedFiles] = useState([]);
  ...
  const handleFileChange = (e) => {
    ...
    // Check if any files were selected from a folder
    const hasDirectoryFiles = selectedFiles.some((file) =>
...
const handlePreviewFile = (file) => {
  setVisibleFiles(prev => ({
    ...prev,
    [file.name]: !prev[file.name] // Toggle visibility
  }));
  ...
  if (previewSceneRef.current) {
    ...
    // Find all meshes associated with this file
    meshes.forEach(mesh => {
      const meshFilename = originalMeshDataRef.current[mesh.name]?.filename;
      if (meshFilename === file.name) {
        mesh.setEnabled(!visibleFiles[file.name]); // Toggle visibility
      }
    });
  }
};
...
const handleSave = async () => {
  ...
  const loadAllModelsInScene = () => {
    ...
    if (glbFiles?.length === 0) {
      ...
      // Initialize visibility for all files
  const initialVisibility = {};
  glbFiles.forEach(file => {
    initialVisibility[file.name] = true; // Default to visible
  });
  setVisibleFiles(initialVisibility);
    ...
    function checkAllLoaded() {
      ...
      const progressPercent = Math.round(
        (loadedCount / glbFiles?.length) * 100
      );
  ...
  }, [fileNamePath?.length, convertedFile?.length, previewButton]);
  ...
  return (
    <div className="bulk-import-container">
      <div className="container-fluid p-0 h-100">
        {/* Header Section */}
        <header className="bulk-import-header py-3 px-4">
          <h4 className="mb-0 text-white">Bulk Model Import</h4>
        </header>

        <div className="row g-0 h-90">
          {/* Left Panel */}
          <div className="col-md-6 d-flex flex-column border-end border-secondary">
            {/* File Upload Section */}
            <div className="file-upload-section p-3">
              <div
                className="drop-zone p-4 mb-3 rounded"
                onDragOver={(e) => e.preventDefault()}
                onDrop={handleDrop}
              >
                <label htmlFor="bulkImportFiles" className="drop-zone-label">
                  <div className="drop-zone-icon">
                    <FontAwesomeIcon icon={faFile} size="2x" />
                  </div>
                  <p className="mb-2">Drag and drop files/folders here</p>
                  <small className="text-muted">or choose from below</small>
                </label>

                <div className="d-flex gap-2 justify-content-center mt-2">
                  {/* Button to select files */}
                  <label className="btn btn-sm btn-grey">
                    Select Files
                    <input
                      type="file"
                      multiple
              ...
              {files?.length > 0 && (
                <div className="file-list-container">
                  <div className="file-list-header d-flex justify-content-between align-items-center mb-2">
                    <span className="small text-muted">Selected Files</span>
            ...
            {/* Action Buttons */}
            <div className="action-buttons p-3 border-top border-secondary">
              <div className="d-flex gap-2">
                ...
                <button
                  className={`btn btn-sm flex-grow-1 ${
                    previewButton ? "btn-success" : "btn-outline-success"
                  }`}
                  onClick={() => setPreviewButton(!previewButton)}
                >
                  {previewButton ? "Previewing" : "Preview"}
                </button>
              </div>
            </div>

            {/* Options Section */}
            <div className="options-section p-3 border-top border-secondary">
              <h6 className="section-title">Processing Options</h6>
              ...
              <div className="form-check form-switch mb-2">
                ...
                />
                <label className="form-check-label" htmlFor="removeAnimation">
                  Remove Animation
                </label>
              </div>
              ...
              <div className="form-check form-switch mb-3">
                ...
                />
                <label className="form-check-label" htmlFor="removeMaterials">
                  Remove Textures & Materials
                </label>
              </div>

              <div className="simplification-control mb-3">
                <label htmlFor="simplificationFactor" className="form-label">
                  Simplification Angle (degrees)
                </label>
                <input
                  type="number"
                  className="form-control form-control-sm w-25"
                  id="simplificationFactor"
            ...
            <div className="transformation-section p-3 border-top border-secondary">
              <h6 className="section-title">Model Transformation</h6>

              <div className="transformation-grid">
                {/* Translation */}
                <div className="transformation-group">
                  <h6 className="transformation-heading">Translation</h6>
                ...
                {/* Rotation */}
                <div className="transformation-group">
                  <h6 className="transformation-heading">Rotation</h6>
                  <div className="transformation-inputs">
                    <div className="transformation-input">
                      <label>X</label>
                      <input
                ...
                {/* Scale */}
                <div className="transformation-group">
                  <h6 className="transformation-heading">Scale</h6>
                  <div className="transformation-inputs">
                    <div className="transformation-input">
                      <label>X</label>
                      <input
          ...
          <div className="col-md-6 d-flex flex-column">
            ...
            <div className="converted-files-section p-3">
              <h6 className="section-title">Converted Files</h6>
...
{isConverting && progress === 100 && (
  <div className="text-center  small mt-1 converting-message">
    Converting ...
  </div>
)}
                  ...
                  <div className="file-list">
                    {convertedFile.map((file, index) => (
                      <div key={index} className="file-item">
                        ...
                        <button
  className={`btn btn-sm btn-link ${visibleFiles[file.name] ? 'text-success' : 'text-primary'}`}
  onClick={() => handlePreviewFile(file)}
  title={visibleFiles[file.name] ? 'Hide in preview' : 'Show in preview'}
>
  <FontAwesomeIcon icon={visibleFiles[file.name] ? faEye : faEyeSlash} />
</button>
                          <button
                            className="btn btn-sm btn-link text-danger"
                ...
                <div className="empty-state text-center py-4">
                  ...
                  />
                  <p className="text-muted">No converted files yet</p>
                </div>
              )}
            </div>

            {/* 3D Preview Section */}
            <div className="preview-section flex-grow-1 border-top border-secondary">
              <div className="preview-container">
                ...
                {showMeasureDetailsAbove && (
                  <div className="measurement-display">
                    ...
                    <div className="measurement-details">
                      ...
                      <div className="measurement-axis">
                        <span className="axis-label z-axis">Z</span>
                        <span className="axis-value">
                ...
                <div className="navigation-controls">
                  <button
                    ...
                    title="Orbit Camera"
                    className={`nav-button ${mode !== "fly" ? "active" : ""}`}
                  >
                    <img src="images/orbit.png" alt="Orbit" />
                  </button>
                  <button
                  ...
                  <button
                    ...
                    title="Measure"
                    className={`nav-button ${showMeasure ? "active" : ""}`}
                  >
        ...
        {/* Footer Actions */}
        <div className="bulk-import-footer p-3 border-top border-secondary">
